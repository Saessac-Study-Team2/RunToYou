...
export const deleteImg = () => {
  ...
  return axios(config)
    .then((res) => console.log("deletImg success"))
    .catch((error) => console.log("deletImg error", error));
};
...
export const addImg = (compressedFile) => {
  ...
  return axios(config)
    .then((res) => console.log("addImg success"))
    .catch((error) => console.log("addImg error", error));
};
...
export const deletePlace = (locationid) => {
  ...
  return axios(config)
    .then((res) => console.log("deletePlace success"))
    .catch((error) => console.log("deletePlace error", error));
};
...
export const addProfile = (nickname, info) => {
  ...
  return axios(config)
    .then((res) => console.log("addProfile success"))
